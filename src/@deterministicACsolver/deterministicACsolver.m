% deterministicACsolver is a class for wrapping inverse dynamics solvers
%
% deterministicACsolver is a class that is used to wrap mutiple solvers for
% computing accelartions in articulated structures. 
% Inverse dynamic solvers compute an estimation
% of the dynamic varaibles (joint and spatial accelerations, etc.) given a
...
classdef deterministicACsolver
   % file: @deterministicACsolver/deterministicACsolver.m
   ...
   % Class methods
   methods
      function a = deterministicACsolver(mdl,sns)
         % deterministicACsolver Constructor function
         if nargin > 0
            ...
            error(['You should provide a featherstone-like ' ...
               'model to instantiate deterministicACsolver'] )
         end
      end % deterministicACsolver
      
      function disp(a)
         % Display a deterministicACsolver object
         fprintf('deterministicACsolver disp to be implemented! \n')
         disp(a.IDmodel)
      ...
      function y = simY(obj, d)
         % fprintf('Calling the deterministicACsolver simY method \n');
