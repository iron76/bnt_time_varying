function [ obj ] = initSparseIndices( obj )
%INITSPARSEINDICES Summary of this function goes here
%   Detailed explanation goes here

pD = 1;

obj.ibs = zeros(obj.IDmodel.sparseParams.nb, 1);
obj.bs  = zeros(obj.IDmodel.sparseParams.nb, 1);

obj.iDs = zeros(sum(obj.IDmodel.sparseParams.nD), 1);
obj.jDs = zeros(sum(obj.IDmodel.sparseParams.nD), 1);
obj.Ds  = zeros(sum(obj.IDmodel.sparseParams.nD), 1);
