...
%              tau_cla(i,:) = [ ((deltaL2+deltaL1) * 5 * -9.81), (deltaL2 * 5 * -9.81)];
        ...
        GTresults(subjectID,trialID).resMAP_3sens = resMAP_3sens;
        GTresults(subjectID,trialID).resRNEA.tau = resRNEA.tau;
        GTresults(subjectID,trialID).resMAP_3sens.data.y = data.y_3sens;
...
%% joint1
    ...
    tau1_ankleSubj13_MAP  = GTresults(13,2).resMAP_3sens.tau_ankle;
    tau1_ankleSubj2_MAP = GTresults(2, 2).resMAP_3sens.tau_ankle;
...
fig = figure();
    ...
    tau2_hipSubj13_MAP  = GTresults(13,2).resMAP_3sens.tau_hip;
    tau2_hipSubj2_MAP = GTresults(2, 2).resMAP_3sens.tau_hip;
