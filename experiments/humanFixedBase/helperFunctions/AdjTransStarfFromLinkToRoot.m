function root_XStar_linkNum = AdjTransStarfFromLinkToRoot (dmodel, q, linkNum)

% AdjTransfStarFromLinkToRoot provides the adjoint matrix X* (Force vector transform) between the root
