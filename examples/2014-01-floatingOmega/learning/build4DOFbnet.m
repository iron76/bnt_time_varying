function [bnet, R] = build4DOFbnet(bnet, index, q, dq, o0, do0, p0)
...
for i = 1:4
    ...
    if i == 3 || i == 4
        ...
        if i == 1
            ...
            b = Ri'*p0 + 2*dt(i)*cross(o(:,i), Ri'*z0)+cross(o(:,i),cross(o(:,i),r0(:,i)));
            W = commuteOnOrder2(Ri'*z0, -vec_hat(r0(:,i)), index.d2t(i), index.do(i));
            bnet.CPD{index.p(i)}  = gaussian_CPD(bnet, index.p(i),  'mean', b, 'cov', sModel.*eye(d), 'weights', W);
