...
for i = 1:2
    ...
    if i==1
        ...
        bnet.CPD{index.edo(i)}  = gaussian_CPD(bnet, index.edo(i),  'mean', b, 'cov', sModel.*eye(d), 'weights', W, 'clamp_mean', 1, 'clamp_weights', 1, 'clamp_cov', 1);
        ...
        bnet.CPD{index.ep(i)}  = gaussian_CPD(bnet, index.ep(i),  'mean', b, 'cov', sModel.*eye(d), 'weights', W, 'clamp_mean', 1, 'clamp_weights', 1, 'clamp_cov', 1);
        ...
        bnet.CPD{index.ec(i)}  = gaussian_CPD(bnet, index.ec(i),  'mean', b, 'cov', sModel.*eye(d), 'weights', W, 'clamp_mean', 1, 'clamp_weights', 1, 'clamp_cov', 1);
...
for i = 2:-1:1
    ...
    bnet.CPD{index.ef(i)}  = gaussian_CPD(bnet, index.ef(i),  'mean', b, 'cov', sModel.*eye(d), 'weights', W, 'clamp_mean', 1, 'clamp_weights', 1, 'clamp_cov', 1);
    ...
    bnet.CPD{index.eu(i)}  = gaussian_CPD(bnet, index.eu(i),  'mean', b, 'cov', sModel.*eye(d), 'weights', W, 'clamp_mean', 1, 'clamp_weights', 1, 'clamp_cov', 1);
end
