...
%init distributions
bnet.CPD{index.mdo0}   = gaussian_CPD(bnet, index.mdo0,    'mean', zeros(d,1), 'cov', Sdo0, 'clamp_mean', 1, 'clamp_weights', 1,                                    'clamp_cov', 1, 'weights', eye(d));
bnet.CPD{index.mp0}    = gaussian_CPD(bnet, index.mp0,     'mean', zeros(d,1), 'cov', Sp0,  'clamp_mean', 1, 'clamp_weights', 1,                                    'clamp_cov', 1, 'weights', eye(d));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
bnet.CPD{index.md2t(1)} = gaussian_CPD(bnet, index.md2t(1),'mean', zeros(1,1), 'cov', Sd2t1, 'clamp_mean', 1, 'clamp_weights', 1,                                   'clamp_cov', 1, 'weights', eye(1));
bnet.CPD{index.md2t(2)} = gaussian_CPD(bnet, index.md2t(2),'mean', zeros(1,1), 'cov', Sd2t2, 'clamp_mean', 1, 'clamp_weights', 1,                                   'clamp_cov', 1, 'weights', eye(1));
